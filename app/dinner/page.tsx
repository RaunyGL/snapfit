      ...
      <div>
        <ScrollArea className="overflow-y-scroll [&::-webkit-scrollbar]:hidden max-h-[500px] w-11/12 mx-auto mt-6 rounded-md border bg-white drop-shadow-lg">
          ...
          <div className="p-4">
            ...
            <ul>
              {dinners.map((dinner) => (
                <li className="text-base">{dinner.food.name}
                <li className="text-sm">{dinner.food.servingSize} - {dinner.food.calories} kcal</li>
                <EditDialog />
