...
import { Edit, Edit2, Loader2, Plus, Trash2 } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogFooter,
...
const ListEdit = ({ food, user }: ListProps) => {
        ...
        <li>
          <div className="flex justify-end">
            <Dialog open={dialogIsOpen} onOpenChange={setDialogIsOpen}>
              <DialogTrigger>
                <Button className="mr-10 " variant="link" size="icon">
                  <Edit size={20} />
                </Button>
              </DialogTrigger>
              <Button className="mr-2" variant="link" size="icon">
                <Trash2 size={20} />
              </Button>
